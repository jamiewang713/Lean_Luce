"""Validate actual Lean audit output and both frozen semantic snapshots."""
...
data = (root / "audit/section5-late-decomposition-audit.log").read_bytes()
...
(root / "audit/section5-late-decomposition-axioms.txt").write_text("\n".join(reports) + "\n", encoding="utf-8")
checks = {}
