...
"Closed Section 4 contract check": "| Closed Section 4 contract check | `section4_contractCheck : ShellMigrationContract.section4` in `Luce/ShellContractCheck.lean` | None outside the universally quantified closed contract | Checked. No additional explicit, implicit, or instance parameters. Included in the default build through `Luce.lean`. |",
}
