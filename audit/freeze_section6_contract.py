"""Freeze the contract's production dependency closure; refuse to overwrite."""
...
target = root / 'audit/section6-contract-freeze.json'
paths = set()
...
visit(root / 'Luce/Section6Contract.lean')
...
if target.exists():
    ...
    print(f'Frozen {len(snapshot)} source/configuration files.')
