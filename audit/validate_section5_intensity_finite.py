"""Validate full-intensity axiom reports and frozen mathematical inputs."""
...
data = (root / "audit/section5-intensity-finite-audit.log").read_bytes()
...
(root / "audit/section5-intensity-finite-axioms.txt").write_text("\n".join(reports) + "\n", encoding="utf-8")
checks = {}
